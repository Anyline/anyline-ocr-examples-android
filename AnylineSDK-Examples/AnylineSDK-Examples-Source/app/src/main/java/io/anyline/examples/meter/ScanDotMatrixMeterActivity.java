...
/**
 * <p>Example activity to scan dot matrix meters.</p>
 */
public class ScanDotMatrixMeterActivity extends AppCompatActivity implements CameraOpenListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_energy_dotmatrix);
        ...
        energyScanView.initAnyline(getString(R.string.anyline_license_key), new EnergyResultListener() {
            ...
            public void onResult(EnergyResult energyResult) {
                ...
                resultDialog = new ResultDialogBuilder(ScanDotMatrixMeterActivity.this)
                        ...
                        .setTitle(getString(R.string.title_dot_matrix_meter))
        ...
        // DOT_MATRIX_METER will scan dot matrix digital meters
        energyScanView.setScanMode(EnergyScanView.ScanMode.DOT_MATRIX_METER);
    }
