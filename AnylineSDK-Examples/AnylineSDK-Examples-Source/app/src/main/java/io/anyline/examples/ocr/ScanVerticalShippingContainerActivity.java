...
public class ScanVerticalShippingContainerActivity extends ScanActivity implements AnylineDebugListener {

    private static final String TAG = ScanVerticalShippingContainerActivity.class.getSimpleName();
    ...
    void init() {
        ...
        scanViewPlugin.addScanResultListener(new ScanResultListener<OcrScanResult>() {
            ...
            public void onResult(OcrScanResult result) {
                ...
                setupScanProcessView(ScanVerticalShippingContainerActivity.this, result, getScanModule());
            }
