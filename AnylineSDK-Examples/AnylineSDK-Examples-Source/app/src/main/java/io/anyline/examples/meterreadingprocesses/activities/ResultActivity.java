...
public class ResultActivity extends BaseToolbarActivity {
    ...
    private void saveResult() {
        ...
        try {
            ...
            ScanActivity.setupScanProcessView(ResultActivity.this, mReading.getNewReading().toString() ,ScanModuleEnum.ScanModule.BARCODE, BitmapUtil.getBitmap(mReading.getCutoutImageLocalPath()), null, null);
