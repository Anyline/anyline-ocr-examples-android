...
public class ScanDutchDrivingLicenseActivity extends ScanActivity implements CameraOpenListener {

    private static final String TAG = ScanDutchDrivingLicenseActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_dutch_driving_license);
    ...
    void init() {
        ...
        drivingLicenseConfig.setScanMode(DrivingLicenseConfig.DrivingLicenseCountry.NL);
        ...
        scanViewPlugin.addScanResultListener(new ScanResultListener<ScanResult<ID>>() {
            ...
            public void onResult(ScanResult<ID> idScanResult) {
                ...
                setupScanProcessView(ScanDutchDrivingLicenseActivity.this, idScanResult, getScanModule());
            }
