...
public class CropViewUIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_activity_crop_view_ui);
        ...
        cropViewUI.setCropViewUIListener(new CropViewUI.CropViewUIListener() {
            ...
            @Override
            public void onSave(String pathCroppedFile, ArrayList<PointF> scaledCorners) {
                ...
                data.putExtra(CropViewUI.RESULT_CROPPED_IMAGE_PATH, pathCroppedFile);
