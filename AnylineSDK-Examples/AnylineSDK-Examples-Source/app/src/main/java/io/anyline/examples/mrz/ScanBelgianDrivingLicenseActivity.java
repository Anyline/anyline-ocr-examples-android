...
public class ScanBelgianDrivingLicenseActivity extends ScanActivity implements CameraOpenListener {


    private static final String TAG = ScanBelgianDrivingLicenseActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_belgian_driving_license);
    ...
    void init() {
        ...
        drivingLicenseConfig.setScanMode(DrivingLicenseConfig.DrivingLicenseCountry.BE);
        ...
        scanViewPlugin.addScanResultListener(new ScanResultListener<ScanResult<ID>>() {
            ...
            public void onResult(ScanResult<ID> idScanResult) {
                ...
                setupScanProcessView(ScanBelgianDrivingLicenseActivity.this, idScanResult, getScanModule());
            }
